...
\newcommand{\probP}{\text{I\kern-0.11em P}}
\newcommand{\probR}{\text{I\kern-0.15em R}}
\newcommand{\Ifunc}{\mathbf{1}\textbf{\kern-0.15em I}}
...
\definecolor{dpink}{RGB}{255,102,102}
\definecolor{spink}{RGB}{255,230,230}
...
\definecolor{BrickRed}{RGB}{204,0,0}
...
bicolor,
sharp corners,
borderline west={4pt}{0pt}{dpink},
}{
\textcolor{black}{
\sffamily
\textbf{{\color{dpink}Warning~\thetcbcounter:}} % Definition counter
{\color{black} #1}  % Definition content
}%
}
...
\textcolor{black}{
\sffamily
\textbf{{\color{royalpurple}Note~\thetcbcounter:}} % Definition counter
{\color{black} #1}  % Definition content
}%
}
...
%%%website for new colors: https://www.rapidtables.com/web/color/RGB_Color.html